  ...
  return (
    <div className='Manufacturing-main-container px-md-5 px-3 py-5'>
      ...
      <div className='Manufacturing-img-container row p-md-5 p-4 d-flex justify-content-between align-items-center mt-md-2 mt-4 '>
        <div className='Manufacturing-img-box col-lg-3  col-md-5 col-12 text-center mt-md-0 mt-3'>
          <img
            src={SolidBlocks}
        ...
        <div className='Manufacturing-img-box col-lg-3 col-md-5 col-12 text-center mt-md-0 mt-4 '>
          <img
            src={PaverBlock}
            style={{ width: '100%', height: '100%' }}
            className='img-fluid'
